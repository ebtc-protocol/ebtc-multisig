...
interface ICdpManager {
  ...
  event CdpDebtRedistributionIndexUpdated(
    bytes32 _cdpId,
    uint256 _cdpDebtRedistributionIndex
  );
  ...
  event StEthIndexUpdated(
    uint256 _oldIndex,
    uint256 _newIndex,
    uint256 _updTimestamp
  );
  event StakingRewardSplitSet(uint256 _stakingRewardSplit);
  event SystemDebtRedistributionIndexUpdated(
    uint256 _systemDebtRedistributionIndex
  );
  ...
  function canLiquidateRecoveryMode(
    uint256 icr,
    uint256 tcr
  ...
  function getCdpLiquidatorRewardShares(
    bytes32 _cdpId
  ) external view returns (uint256);
  ...
  function getSyncedCdpCollShares(
    bytes32 _cdpId
  ) external view returns (uint256);
  ...
  function hasPendingRedistributedDebt(
    bytes32 _cdpId
  ) external view returns (bool);
